...
export class TextGenerator {
	...
	public static generateText(minLength: number = 300): string {
		...
		} while (sentences.join(' ').length < minLength); // Repeat until text length was reached
	 ...
	 * @protected
	 */
	protected static getRandomWord() {
		return TextGenerator.DICTIONARY[Utils.randomInteger(0, TextGenerator.DICTIONARY.length - 1)];
	}

	/**
	 * A list of words used for generating text.
